...
<script type="text/javascript">var map=new L.Map("map");var cloudmadeUrl="http://{s}.mqcdn.com/tiles/1.0.0/osm/{z}/{x}/{y}.png",subDomains=["otile1","otile2","otile3","otile4"],cloudmadeAttrib='Data, imagery and map information provided by <a href="http://open.mapquest.co.uk" target="_blank">MapQuest</a>, <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> and contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/" target="_blank">CC-BY-SA</a>';var cloudmade=new L.TileLayer(cloudmadeUrl,{maxZoom:18,attribution:cloudmadeAttrib,subdomains:subDomains});map.addLayer(cloudmade).setView(new L.LatLng(42.21703,-8.7144),11);var marker=new L.Marker(new L.LatLng(42.21703,-8.7144));map.addLayer(marker);marker.bindPopup("Autovidro<br>Ctra. Miraflores N.93<br>36214 Vigo<br>(Pontevedra)").openPopup();</script>

<script type="text/javascript">$(window).load(function(){$(".flexslider-ofertas").flexslider({animation:"slide",controlsContainer:".flex-container",directionNav:false})});</script>
