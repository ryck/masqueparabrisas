...
<div class="pagination pagination-centered">
	<ul id="pagination-list">
		<li<?php if ($page == 1): ?> class="disabled" <?php endif; ?>><a href="#" data-page="<?php echo max(1, $page-1); ?>" data-filter="<?php echo $filter; ?>" data-term="<?php echo $termt; ?>">«</a></li>
		<?php
		//Show page links
		for($i=1; $i<=$pages; $i++)
		{
		...
		?>
		<li<?php if ($page == $pages): ?> class="disabled" <?php endif; ?>><a href="#" data-page="<?php echo min($pages, $page+1); ?>" data-filter="<?php echo $filter; ?>" data-term="<?php echo $termt; ?>">»</a></li>
	</ul>
</div>